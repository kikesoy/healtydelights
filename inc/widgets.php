...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Content Sidebar 2', 'understrap' ),
				'id'            => 'content-sidebar-2',
				'description'   => __( 'Content sidebar 2 widget area', 'understrap' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Nav', 'understrap' ),
				'id'            => 'footernav',
				'description'   => __( 'Nav menu footer widget', 'understrap' ),
				'before_widget' => '<nav id="%1$s" class="footer-navbar %2$s">',
				'after_widget'  => '</nav><!-- .footer-navbar -->',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
			)
		);
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Brand', 'understrap' ),
				'id'            => 'footerbrand',
				'description'   => __( 'Brand area in footer widget', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="footer-brand %2$s">',
				'after_widget'  => '</div><!-- .footer-brand -->',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
			)
		);
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Auxiliar', 'understrap' ),
				'id'            => 'footeraux',
				'description'   => __( 'Auxiliar footer widget with dynamic grid', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="footer-auxiliar %2$s dynamic-classes">',
				'after_widget'  => '</div><!-- .footer-auxiliar -->',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
			)
		);
